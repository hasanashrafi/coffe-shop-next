        ...
        <section className='mt-8 mb-10 md:my-20'>
            <div className='container max-w-7xl '>
               ...
               <Link href='/products' className='bg-cover flex flex-col justify-center items-start pr-7 md:pr-12  bg-category-right rounded-2xl  h-[142px] md:h-[248px] '>
                    <span className='font-DanaDemiBold text-xl md:text-4xl/6 mb-4 md:mb-7 text-zinc-700 dark:text-white'>
                        انواع قهوه
                    </span>
                ...
                <Link href='/' className='bg-cover flex flex-col justify-center items-start pr-7 md:pr-12 bg-category-left  rounded-2xl  h-[142px] md:h-[248px] '>
                    <span className='font-DanaDemiBold text-xl/6 md:text-4xl/6 mb-4 md:mb-7 text-zinc-700 dark:text-white'>
                        پودر های فوری
                    </span>
                    <p className=' md:text-xl/6 md:font-DanaMedium mt-0.5 md:mt-1.5 text-zinc-700 dark:text-white'>
