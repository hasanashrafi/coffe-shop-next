    ...
    return (
        <>
            <svg className="hidden">
                ...
                <symbol id='bars-3' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </symbol>
                <symbol id='shopping' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div className='flex md:hidden justify-between items-center  w-full px-4 bg-white dark:bg-zinc-700 h-16'>
                <div>
