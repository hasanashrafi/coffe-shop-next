    ...
    <nav className="flex items-center gap-x-6 lg:gap-x-9  h-14">
      ...
      <ul className="w-full h-full flex items-center text-md lg:text-md tracking-tightest gap-x-5  lg:gap-x-9 text-gray-300">
        ...
        <li className='group relative '>
          ...
          <ul className='  invisible  opacity-0 mt-2 absolute z-50 delay-75  w-52 bg-white drop-shadow-lg p-6 rounded-2xl border-t-2 border-t-orange-200 shadow-dark  group-hover:opacity-100 leading-[56px]  group-hover:visible tracking-normal top-full text-base transition-all ease-in-out space-y-4 dark:bg-zinc-700 dark:child:text-white dark:child-hover:text-orange-300 first-line:text-orange-300 child:block  child:text-sm  child-hover:text-orange-300 child:transition-colors child:text-slate-900'>
            <Links />
          </ul>
        </li>
        <li>
